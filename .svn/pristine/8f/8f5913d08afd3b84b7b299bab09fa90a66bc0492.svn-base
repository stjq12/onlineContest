<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="问题内容" min-width="460px" align="center">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="70px" style="width: 85%; margin-left:50px;">
        <el-form-item label="问题" prop="pcontent">
          <el-input v-model="temp.qcontent" :autosize="{ minRows: 1, maxRows: 3}" type="textarea" placeholder="请输入问题" />
        </el-form-item>
        <el-form-item label="回答" prop="answer">
          <el-input v-model="temp.answer" :autosize="{ minRows: 4, maxRows: 10}" type="textarea" placeholder="请输入回答" />
        </el-form-item>
      </el-form>
...
import { getQuestionList, addQuestion, deleteQuestion, updateQuestion, search } from '@/api/Article/question'
